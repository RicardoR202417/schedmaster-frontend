...
export const metadata: Metadata = {
  title: "SchedMaster · Gimnasio universitario UTEQ",
  description: "Reserva tu horario, consulta convocatorias y gestiona tu acceso al gimnasio universitario UTEQ.",
};
